...
import WhitelistConfigEditor from "@/components/WhitelistConfigEditor.vue";
...
<template>
  <WhitelistConfigEditor v-if="isWhitelistConfig" :config="props.config" />
  <a-col v-if="!isWhitelistConfig" :span="24">
  ...
  <a-col v-if="data && !isWhitelistConfig" :span="24">
    <CardPanel style="height: 100%">
      <template #body>

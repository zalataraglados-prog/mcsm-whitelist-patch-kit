...
export const INSTANCE_CONFIGS: InstanceConfigs[] = [
  ...
  {
    fileName: "[Whitelist] whitelist.json",
    path: "whitelist.json",
    redirect: "common/whitelist.json",
    type: "json",
    info: "Whitelist is UUID-based. Entries can represent either online/external UUIDs or offline-derived UUIDs.",
    category: [
      TYPE_MINECRAFT_SPIGOT,
      TYPE_MINECRAFT_PAPER,
      TYPE_MINECRAFT_FOLIA,
